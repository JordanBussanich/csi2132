...
insert into BillingInformation values(10000, 1234567890123456, '10/13', 'discover');

insert into Billinginformation values(10001, 4950213226542654, '10/13', 'visa');
insert into Billinginformation values(10002, 4955516516156156, '10/13', 'visa');
insert into Billinginformation values(10003, 4549515165418989, '10/13', 'visa');
insert into Billinginformation values(10004, 2315641988484998, '10/13', 'visa');
insert into Billinginformation values(10005, 2135641894984898, '10/13', 'visa');
insert into Billinginformation values(10006, 8749481981891815, '10/13', 'visa');
insert into Billinginformation values(10007, 2123598894849845, '10/13', 'visa');
insert into Billinginformation values(10008, 2315648948941818, '10/13', 'visa');
insert into Billinginformation values(10009, 2135498494948422, '10/13', 'visa');
insert into Billinginformation values(10010, 1859489489189189, '10/13', 'visa');

insert into Billinginformation values(10011, 1815619881251689, '10/13', 'mc');
insert into Billinginformation values(10012, 2566156456448465, '10/13', 'mc');
insert into Billinginformation values(10013, 5645412645645656, '10/13', 'mc');
insert into Billinginformation values(10014, 2345489489256521, '10/13', 'mc');
insert into Billinginformation values(10015, 1235494898126215, '10/13', 'mc');
insert into Billinginformation values(10016, 4568912185961852, '10/13', 'mc');
insert into Billinginformation values(10017, 1235641849815645, '10/13','mc');
insert into Billinginformation values(10018, 4568991231565445, '10/13', 'mc');
insert into Billinginformation values(10019, 2315496484984848, '10/13', 'mc');
insert into Billinginformation values(10020, 2354984912589454, '10/13', 'mc');

insert into Billinginformation values(10021, 5465961918918194, '10/13', 'amex');
insert into Billinginformation values(10022, 5541619618511232, '10/13', 'amex');
insert into Billinginformation values(10023, 1561826852135152, '10/13', 'amex');
insert into Billinginformation values(10024, 1451562892899641, '10/13', 'amex');
insert into Billinginformation values(10025, 1235419485948565, '10/13', 'amex');
insert into Billinginformation values(10026, 3458945256569852, '10/13', 'amex');
insert into Billinginformation values(10027, 4568945666854196, '10/13', 'amex');
insert into Billinginformation values(10028, 4568949812135642, '10/13', 'amex');
insert into Billinginformation values(10029, 1235496845216189, '10/13', 'amex');
insert into Billinginformation values(10030, 1235641894189192, '10/13', 'amex');
